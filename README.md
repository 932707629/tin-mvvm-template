...
升级注意点：
- wizard-template.jar注意要和android studio安装目录里的文件同步
- 目前jdk用的版本是jdk11
- 自定义模板说明(https://www.bigademo.com/2021/01/20/AndroidStudio%204.1%E8%87%AA%E5%AE%9A%E4%B9%89%E6%A8%A1/index.html)
- 自定义模板遇到的问题(https://blog.csdn.net/weichikai/article/details/115446477)
...
- with the [Gradle Qodana Plugin][gh:gradle-qodana-plugin], so you can use it on the local environment or any CI me.soushin.tinmvvm.template.other than GitHub Actions.
...
Now proceed with providing more entries to the `Added` group, or any me.soushin.tinmvvm.template.other one that suits your change the most (see [How do I make a good changelog?][keep-a-changelog-how] for more details).
